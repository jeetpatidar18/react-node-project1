...
export default function RegLibrary(){
    ...
    const handleCollegeCodeText=(evt)=>{
        setCollegeCode(evt.target.value);
    }
    ...
    const handleRegButton=()=>{
        ...
        axios.post("http://localhost:5550/library/registration",obj)
            ...
            <center>
                ...
                <table>
                    ...
                    <tr>
                        <td>College Code</td>
                        <td>
                            <input type="number"onChange={handleCollegeCodeText}></input>
                        </td>
                    </tr>
                    <tr>
                        <td>Reg Date</td>
